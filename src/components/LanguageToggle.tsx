...
import { LanguageSelectHint } from "./LanguageSelectHint";
...
export function LanguageToggle({ onInteract, showHandHint = false }: Props) {
  ...
  return (
    <div className="flex w-max flex-col items-stretch">
      ...
      <AnimatePresence>
        {showHandHint && <LanguageSelectHint key="lang-hand" />}
      </AnimatePresence>
    </div>
  );
}
